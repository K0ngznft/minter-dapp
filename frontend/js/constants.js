...
const welcome_h1 = "Welcome to the Jungle";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = '5,000 Kongz from deep in the heart of the jungle who wandered onto the Ethereum Blockchain.';
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Welcome to the Jungle ";
...
const p_public_mint = "Mint Your Kongz Below 🦍";
...
const button_public_mint = "Mint Your Kongz";
